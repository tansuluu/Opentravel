...
public class Sprint4 {
    ...
    public static boolean BLO7(WebDriver driver,Main sp) {
        String expectedTitle = "Opentravel";
        Sprint1.BLO2(driver,sp);
    ...
    public static boolean BLO15(WebDriver driver,Main sp) {
        String expectedTitle = "Opentravel";
        Sprint1.BLO2(driver,sp);
    ...
    public static boolean LUP2(WebDriver driver,Main sp) {
        String expectedTitle = "Opentravel";
        Sprint1.LUP12(driver,sp);
        driver.findElement(By.id("addLike")).click();
        if(driver.findElement(By.id("deleteLike")).getText().equals("0")){
    ...
    public static boolean LUP17(WebDriver driver,Main sp) {
        String expectedTitle = "Opentravel";
        Sprint1.LUP12(driver,sp);
        driver.findElement(By.id("deleteLike")).click();
    ...
    public static boolean LUP3(WebDriver driver,Main sp) {
        String expectedTitle = "Opentravel";
        Sprint1.LUP12(driver, sp);
